					...
					<td colspan="2"><div id="pnTop">
							<div id="pnTopDisplay" style="width: 100%; float: left">
								...
								<div id='ctl06_portlet_83a3e05a-eb99-4512-bd1a-5af90706fcf3'
									style="width:70%; float: left;margin-left:50px">
											...
											<div class="slider-wrapper theme-default">
												<div id="slider" class="nivoSlider">
													...
													<a href="#" target="_blank"> <img
														src="<c:url value = "/resources/Resources/imagesPortlet/hnqt/01.jpg"/>"
														title="" /></a> <a href="#" target="_blank"> <img
														src="<c:url value = "/resources/Resources/imagesPortlet/hnqt/02.jpg"/>"
														title="" /></a> 
								...
								<div id='ctl06_portlet_8b056785-3dc4-4de8-9516-a546e8152a5c'
									...
									<div>
										<div class="addute">
											...
											<p>
												<span style="font-size: 14px; color: #ffffff;">Professors, Associate Professors, Senior Lecturers, Lecturers </br>and other experts in the fields of Computer Science, System, System Model, Software Engineering </br>and Service Science are welcome to join us and review papers of ICSSE 2018.
												</span>
											</p>
										</div>
