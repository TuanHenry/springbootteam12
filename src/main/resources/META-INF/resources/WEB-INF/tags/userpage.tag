...
<body class="body" onload='popunder();'>
						...
						<td colspan="2"><div id="pnTop">
								<div id="pnTopDisplay" style="width: 1000px; float: left">
									...
									<div id='ctl06_portlet_83a3e05a-eb99-4512-bd1a-5af90706fcf3'
										style="width: 574px; float: left;margin-left:50px">
										<div>
											  ...
											  <div class="P_top">
												<div class="P_logo">
													...
													<%--<div class="anh_logo">
														<img alt=""
															src="<c:url value = "/resources/Resources/Images/SubDomain/icsse2017/3.jpg"/>"
									...
									<div id='ctl06_portlet_6299a742-1878-4325-8536-4faefa3c1b4c'
										...
										<a
													href="/login"
														...
														class="rmLink rmRootLink"><button style="font-size:15px;margin-top:20px;font-style:cabin;border: none;
  background: #1abc9c;
  cursor: pointer;
  border-radius: 3px;
  padding: 6px;
  ...
  color: white;
  margin-left: 25px;
  box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.2)">Đăng Nhập</button></a>
												...
												<div class="slider-wrapper theme-default">
													<div id="slider" class="nivoSlider">
														...
														<a href="#" target="_blank"> <img
															src="<c:url value = "/resources/Resources/imagesPortlet/e28a24d5-befe-4213-a3d5-2e1ebcb2a71e/01.jpg"/>"
															title="" /></a> <a href="#" target="_blank"> <img
															src="<c:url value = "/resources/Resources/imagesPortlet/e28a24d5-befe-4213-a3d5-2e1ebcb2a71e/02.jpg"/>"
															title="" /></a> 
									...
									<div id='ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666'
										...
										<div>
											...
											<div class="truycap_ute">
												...
												<p>
													Conference Secratary	Ms. Linda Zhou
												</p>
												<p class="line_footer"></p>
												<p>
													Email: icsse@iact.net	Tel: +852-30623054
												</p>
											</div>
									...
									<div id='ctl06_portlet_8b056785-3dc4-4de8-9516-a546e8152a5c'
										...
										<div>
											<div class="addute">
												...
												<p>
													<span style="font-size: 14px; color: #ffffff;">Professors, Associate Professors, Senior Lecturers, Lecturers</br> and other experts in the fields of Computer Science, System, System Model, Software Engineering </br>and Service Science are welcome to join us and review papers of ICSSE 2018.</br> 
													</span>
												</p>
											</div>
